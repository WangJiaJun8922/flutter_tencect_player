package com.kenwang.flutter_tc_player;
...
/**
 * FlutterTcPlayerPlugin
 */
public class FlutterTcPlayerPlugin implements MethodCallHandler {
  ...
  private FlutterTcPlayerPlugin(Registrar registrar) {
    this.registrar = registrar;
    this.videoPlayers = new LongSparseArray<>();
  }

  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_tc_player");
    final FlutterTcPlayerPlugin plugin = new FlutterTcPlayerPlugin(registrar);
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    switch (call.method) {
      ...
      case "create":
        ...
        EventChannel eventChannel = new EventChannel(registrar.messenger(), "flutter_tc_player/videoEvents" + handle.id());
